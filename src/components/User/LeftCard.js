...
const LeftCard = () => {
  return (
    <div
      className={`${classes["profile-card"]} before:bg-[#9db4f4] dark:before:bg-[#4e409d] flex lg:min-h-[82vh] flex-wrap flex-col items-center bg-gray-200 dark:bg-gray-900 rounded-md relative lg:sticky mb-6 lg:mb-0 md:w-10/12 lg:w-4/12 dark:text-white p-6 py-8 shadow-lg`}
    >
      <img
