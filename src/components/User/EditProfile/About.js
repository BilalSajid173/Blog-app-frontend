    ...
    <div className="w-full">
      ...
      <div className="flex flex-wrap justify-center">
        <button
          ...
          className="border-2 text-lg hover:text-white border-blue-500 p-2 px-6 mt-4 rounded-md hover:bg-blue-500 mr-2"
        >
          Previous
        </button>
        <button
          onClick={props.nextHandler}
          className="border-2 text-lg hover:text-white border-blue-500 p-2 px-6 mt-4 rounded-md hover:bg-blue-500"
        >
          Next
        </button>
      </div>
