        ...
        <div>
          <form onSubmit={formSubmitHandler}>
            <div className="w-full">
              ...
              <div className="rounded-sm my-1 w-full border-0 outline-none">
                ...
                <button
                  disabled={enteredTag === ""}
                  type="button"
                  className="rounded-sm w-[24%] ml-[1%] p-2 bg-blue-400 hover:bg-blue-500 disabled:hover:bg-blue-400 disabled:opacity-70 disabled:cursor-not-allowed dark:bg-slate-600"
            ...
            <div className="flex flex-wrap items-center my-2">
              ...
              <label
                for="imagepick"
                className="p-1 px-3 bg-blue-400 cursor-pointer rounded-sm hover:bg-blue-500 mr-3 dark:bg-slate-600"
                type="button"
              >
                Choose Image
              </label>
            ...
            <button
              className="p-1 px-3 my-3 bg-blue-400 cursor-pointer rounded-sm w-full hover:bg-blue-500 dark:bg-slate-600"
              type="submit"
            >
              Submit
            </button>
          ...
          <div className="border border-gray-300 dark:border-gray-500 flex flex-col p-3 bg-white dark:bg-[#07244C] dark:text-white my-3 first:mt-0 rounded-sm">
            ...
            <div className="">
              <h1 className="text-2xl font-bold">{enteredTitle}</h1>
              <p>{enteredContent}</p>
