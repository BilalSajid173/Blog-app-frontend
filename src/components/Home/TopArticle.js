...
const TopArticle = (props) => {
  return (
    <div className="transition-all duration-300 bg-gray-200 w-[100%] rounded-md shadow-md shadow-gray-400 hover:scale-90 cursor-pointer dark:shadow-none dark:bg-gray-800">
